...
class Session(object):
    ...
    def __init__(self, tid, user_id, user_role, user_status, privkey, pubkey):
...
def new_session(tid, user_id, user_role, user_status, privkey, pubkey):
    session = Session(tid, user_id, user_role, user_status, privkey, pubkey)
